...
const Contact: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contacto - EGN Fitness</title>
        <meta
          name='description'
          content='Contacta con el equipo de EGN Fitness. Resuelve tus dudas sobre suplementación deportiva personalizada.'
        />
      ...
      <div className='max-w-3xl mx-auto px-4 py-8'>
        <div className='text-center mb-12'>
          ...
          <p className='text-lg text-gray-600 dark:text-gray-300'>
            {t(
              '¿Tienes alguna duda o sugerencia? Rellena el formulario y te responderemos lo antes posible.'
            )}
          </p>
        </div>
          ...
          >
            ...
            <div className='space-y-6'>
              <div className='relative'>
                ...
                <svg
                  className='absolute top-1/2 left-4 -translate-y-1/2 text-gray-400 w-5 h-5'
                  fill='currentColor'
                  viewBox='0 0 20 20'
                >
                  <path
            ...
            {submissionStatus === 'error' && (
              <p className='mt-4 text-center text-red-500 font-semibold animate-fade-in'>
                {formData.name && formData.email && formData.message
                  ...
                  : t('Por favor, completa todos los campos antes de enviar.')}
              </p>
            )}
          </form>
        </div>
