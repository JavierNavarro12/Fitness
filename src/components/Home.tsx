...
const Home: React.FC<HomeProps> = ({ onStart }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 flex flex-col items-center">
      <h2 className="text-3xl font-bold text-red-700 dark:text-red-300 mb-4 text-center">{t('Bienvenido a NutriMind')}</h2>
      <p className="text-lg text-gray-700 dark:text-gray-200 mb-6 text-center">
        {t('NutriMind es tu asesor inteligente de suplementación deportiva. Personaliza tu perfil, genera informes profesionales y resuelve tus dudas con nuestra IA experta. ¡Optimiza tu rendimiento y salud con recomendaciones basadas en tu perfil y objetivos!')}
      </p>
